...
import { updateUserStart,updateUserSuccess,updateUserFailure } from "../app/user/userSlice";
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 w-96">
        <div className="flex flex-col items-center mb-4">
          ...
          <img
            ...
            src={formData.profilePicture || currentUser.profilePicture || noProfile}
            alt="Profile"
            onClick={() => fileRef.current?.click()}
          />
          {uploadProgress > 0 && uploadProgress < 100 ? <b className="text-green-700">uploading in progress { uploadProgress} %</b>:""}
          {/* Name */}
